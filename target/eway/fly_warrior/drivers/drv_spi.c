 ...
 * \param wl32_spi: wl32 spi bus struct.
...
/* attach spi_device_1 (BMI088 GYRO) to spi0 */
    ...
    /* attach spi_device_0 (MS5611 Barometer) to spi1 */
    {
        static struct rt_spi_device rt_spi1_dev0;
        static struct wl32_spi_cs spi1_cs0 = { .gpio_periph = GPIO_PORT_D, .pin = GPIO_PIN_12 };
        ...
        /* set CS pin by default */
        GPIO_SetPins(spi1_cs0.gpio_periph, spi1_cs0.pin);
    ...
    /* attach spi_device_0 (SPI2 FRAM) to spi2 */
    {
